    ...
    <div className="flex flex-col gap-6 p-6 max-w-6xl mx-auto w-full">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-xl border border-[var(--taro-line)] bg-[var(--taro-surface)] p-4">
          ...
          <p className="mt-1 text-3xl font-bold text-[var(--taro-partial-ink)]">
            {total - withCompleted}
          </p>
        </div>
      </div>
      ...
      <div>
        <input
          ...
          className="w-full max-w-sm rounded-lg border border-[var(--taro-line)] bg-[var(--taro-surface)] px-3 py-2 text-sm text-[var(--taro-ink)] placeholder-[var(--taro-ink-muted)] outline-none focus:border-[var(--taro-brass)] transition-colors"
        />
      </div>
              ...
              {filtered.map((s) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-center hidden sm:table-cell">
                    <span className="inline-flex h-6 min-w-6 items-center justify-center rounded-full bg-[var(--taro-raised)] px-1.5 text-xs font-medium text-[var(--taro-ink-muted)]">
                      {s.total_submissions}
                    </span>
                  </td>

                  <td className="px-4 py-3 text-center hidden md:table-cell">
                    <span className="text-[var(--taro-correct)] font-medium">
                      {s.completed_submissions}
                    </span>
                    <span className="text-[var(--taro-ink-muted)]">
                      /{s.total_submissions}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-3 text-[var(--taro-ink-muted)] hidden lg:table-cell">
